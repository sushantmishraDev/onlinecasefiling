...
<h4 class="panel-title">Judgements Pending For Reuploading</h4>
</div>
...
<table id="searchformdisplay" id="data-table" st-table="documentlist" class="table table-striped table-bordered table-hover">
	...
	<tr ng-repeat="data in documentlist">
		<td>{{data.jfd_document_name}}</td>
		<td>
		<button type="button" class="btn btn-primary btn-sm pull-right" ng-click="downloadFile(data,2)">
						    ...
						    <div class="modal-content">
						      <div class="modal-header">
						        ...
						        <h4 class="modal-title" id="myModalLabel"><strong> Upload Document </strong></h4>
					  			...
					  			<%@ include file="../document/_reupload_judgement_form.jsp"%>
						    </div>
						  </div>
					</div>
</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/scripts/controllers/JudgementlistController.js"></script>
