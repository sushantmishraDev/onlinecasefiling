                ...
                <div class="login-content"  >
                    ...
                    <span class="msg_div"></span>
                        ...
                        <div class="login-buttons" ng-show="sendotp">
                            <button type="submit" ng-click="sendOTP()" class="btn btn-success btn-block btn-lg">Send OTP</button>
                        </div>
                ...
                <div class="register-content">
                    ...
                    <span class="msg_div"></span>
                    	<div class="form-group">
	                         ...
	                         <div class="col-md-9">
	                             <label class="radio-inline">
	                                 <input type="radio" ng-model="register.type" ng-change="refresh()" value="aor"/>
	                                 AOR{{registerType}}
	                             </label>
	                             <label class="radio-inline">
	                                 <input type="radio" ng-model="register.type" ng-change="refresh()" value="inperson" />
	                                 In Person
	                             </label>
                         	</div>
                       	</div>
                        ...
                        <div class="form-group" ng-show="register.type=='inperson' || isadvocate">
	                         ...
	                         <div class="col-md-9">
	                             <label class="radio-inline">
	                                 <input type="radio" ng-model="register.gender" value="M"/>
	                                 Male
	                             </label>
	                             <label class="radio-inline">
	                                 <input type="radio" ng-model="register.gender" value="F" />
	                                 Female
	                             </label>
                         	</div>
                       	</div>
                        ...
                        <div class="form-group" ng-show="register.type=='inperson' || isadvocate">
                        	<label class="col-md-3 control-label">Mobile</label>
                         	<div class="col-md-9">
                            	<input numbers-only type="text" maxlength="10" class="form-control" id="mobile"  ng-model="register.mobile" placeholder="Mobile" />
                			</div>
                        </div>
                        <div class="form-group" ng-show="register.type=='inperson' || isadvocate">
