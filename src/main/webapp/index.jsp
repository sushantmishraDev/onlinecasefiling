...
canvas{
  ...
  pointer-events:none;
          ...
          <!--   </em>
                    ...
                    <div class="login-content"  >
                        ...
                        <form class="margin-bottom-0" name="loginFrm" novalidate role="form">
                           ...
                           <div class ="col-md-9 ">  <button type="button" ng-click="speakCaptcha()" class ="speakerImage"></button></div>
                            </div>
                            ...
                            <div class="form-group text-center">
                                <span class="link" ng-click="forgotPwdForm()">Forgot Password</span> &nbsp; | Click <span class="link" ng-click="registerForm()">here</span> to register.
                    ...
                    <div class="login-content">
                        ...
                        <form class="margin-bottom-0" name="fgtpwdFrm" novalidate role="form">
                            ...
                            <div class="form-group" ng-show="validOTP">
                                ...
                                <div data-tip="Password must contains atleast one alphabet,special characters and number">
                            ...
                            <hr />
                            <div class="form-group text-center">
                                <span class="link" ng-click="loginForm()">Login</span> &nbsp; | Click <span class="link" ng-click="registerForm()">here</span> to register.
                                <!-- 						    <span>Forgot Password</span> &nbsp;|&nbsp;<span class="link" ng-click="registerForm()">Create an Account</span>-->
                            </div>
                        </form>
                    </div>
                        ...
                        <form method="POST" class="form-horizontal">
                            ...
                            <div class="form-group" ng-show="register.type=='inperson' || isadvocate">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" oninput="this.value = this.value.toUpperCase()"
                                     id="name" ng-model="register.name" maxlength="60" placeholder="Full Name" />
                                </div>
                            </div>
                            <div class="form-group" ng-show="register.type=='inperson' || isadvocate">
                          ...
                          <!--   <div class="form-group" ng-show="register.type=='inperson' || isadvocate">
                            ...
                            <div class="form-group" ng-show="register.type=='inperson' || isadvocate">
                                ...
                                <div class="col-md-9" data-tip="Password must contains atleast one alphabet,special characters and number">
	...
	<![endif]-->
        ...
        <script type="text/javascript" src="${pageContext.request.contextPath}/js/scripts/controllers/loginController.js?v=4"></script>
        <script>
