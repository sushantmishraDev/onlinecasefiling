					...
					<div class="panel-body">
						<div class="form-group pull-in clearfix">
							...
							<div class="col-sm-6">
								...
								<label>Caveator Mobile <span class="text-danger"> * </span></label> 
							...
							<fieldset class="scheduler-border">
								...
								<div ng-init="caveat.cav_court=1">
									...
									<input type="radio"  id="lowerCourt"  data-ng-click="changeCourt($event)" ng-model="caveat.cav_court"
										...
										ng-model="caveat.cav_court" value="2">High Court
									</label>
								</div>
...
<div class="row" ng-show="addShow">
	<div class="col-md-12">
		...
		<div class="col-md-4">
			<button class="btn btn-success" ng-disabled="!caveat.cav_type || !caveat.cav_dist_mid || !caveat.cav_caveator_name  || !caveat.cav_lc_case_no || !caveat.cav_lc_case_year"
