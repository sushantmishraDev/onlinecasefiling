...
<div id="content" class="content" ng-controller="caveatDraftViewController">
   <div class="row">
<div class="col-md-12">
			        ...
			        <div class="panel panel-inverse overflow-hidden">
                                ...
                                <table id="data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <tr class="odd gradeX">
                                             ...
                                             <td>{{caveat.respondentDetails.rt_name}}</td> 
                                             <td>{{caveat.cav_caveator_name}}</td>
                                             <td>{{caveat.cav_judgmnt_date|date:"dd/MM/yyyy"}}</td>                             
						...
						<div class="panel panel-inverse overflow-hidden" ng-show="registerCase.caseStage.lk_longname=='CAVEAT_REJECTED'">
							<div class="panel-heading">
								<h3 class="panel-title">
									<a class="accordion-toggle accordion-toggle-styled collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseEight">
									    <i class="fa fa-plus-circle pull-right"></i> 
...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/scripts/controllers/caveatDraftViewController.js"></script>
<script type="text/javascript"
