						            ...
						            <div class="panel-heading font-bold">Crime Details</div>
										<div class="panel-body">
                                          ...
                                          <div class="form-group pull-in clearfix">
									          ...
									          ng-model="caveatCrimeDetails.ccd_district"
									...
									<option value="">Select District</option>
                                                ...
                                                <div class="col-sm-6">
													<label class="control-label">Police Station</label> <select class="form-control" id="caseDetail"
														name="caseDetail" ng-model="caveatCrimeDetails.ccd_police_stn"
									...
									<div class="form-group pull-in clearfix">
												...
												<div class="col-sm-6">
													<label class="control-label">Crime No. <span class="text-danger"> * </span>
														...
														ng-model="caveatCrimeDetails.ccd_crime_number">
												</div>
												...
												<div class="col-sm-6">
													...
													<label class="control-label">Crime Year <span class="text-danger"> * </span>
														...
														ng-model="caveatCrimeDetails.ccd_crime_year">
												</div>
												</div>
						                  ...
						                  <button class="btn btn-success" ng-disabled="!caveatCrimeDetails.ccd_district || !caveatCrimeDetails.ccd_police_stn || !caveatCrimeDetails.ccd_crime_number || !caveatCrimeDetails.ccd_crime_year" ng-click="addCrimeDetails(caveatCrimeDetails)">Save</button>
						                     </div>
                                                      ...
                                                      <table id="data-table" class="table table-striped table-bordered">
                                                            ...
                                                            <tbody>
                                                                  <tr ng-repeat="row in crimeDetailList" class="odd gradeX">
                                                                        ...
                                                                        <td>{{row.ccd_crime_number}}</td>
                                                                        <td>{{row.ccd_crime_year}}</td>
