								...
								<div class="col-sm-10" style="float:centre">
											...
											<div class="form-group pull-in clearfix">
												<div class="col-sm-6">
													<label>Name <span class="text-danger">
														...
														ng-model="petitionerDetails.pt_name" required>
												...
												<div class="col-sm-6">
													...
													<label class="control-label">Address
														...
														ng-model="petitionerDetails.pt_address" name="address" placeholder="Address Line 1">
														</textarea>
												</div>
											...
											<div class="form-group pull-in clearfix">
												<div class="col-sm-6">
													<label>Email Id</label><input type="email" class="form-control" maxlength=50
														id="caseDetail" name="email" ng-model="petitionerDetails.pt_email">
														<span style="color:red" ng-show="petitioner.email.$dirty && petitioner.email.$invalid">
                                                           <span ng-show="petitioner.email.$error.email">Invalid email address.</span>
                                                                </span>
														</div>
                                                 
												<div class="col-sm-6">
													<label>City</label> <input  type="text" maxlength=30 class="form-control" id="caseDetail"
														name="caseDetail" ng-model="petitionerDetails.pt_city">
												</div>
											</div>
											...
											<div class="form-group pull-in clearfix">
												<div class="col-sm-6">
													<label>Mobile No</label><input numbers-only type="text"
														class="form-control" id="mobile" name="mobile" maxlength=10  ng-model="petitionerDetails.pt_mobile"/>
							        ...
							        <!--   <span class="error" ng-show="petitionerDetails.mobile.$error.maxlength"><br> mobile number not more than ten digits</span> -->
							         <!--  <span class="error"ng-show="petitionerDetails.mobile.$error.pattern"><br>Enter the valid Mobile Number</span> -->
									       ...
									       ng-model="petitionerDetails.pt_s_id"
							              ...
							              <!--  <span class="error" ng-show="petitioner.pincode.$error.maxlength"><br>Pincode not more than six digits</span>
											 ...
											 <div class="row pull-right">
                                                      <div class="col-sm-12">
						     <button class="btn btn-success" ng-disabled="!petitionerDetails.pt_name" ng-click="petitioner.$valid && addPetitioner(petitionerDetails)">Add Petitioner</button>
						      </div>
                               </div>
                                                </div>
                                                        ...
                                                        <table id="data-table" class="table table-striped table-bordered">
                                                            ...
                                                            <tbody>
                                                                  <tr ng-repeat="row in petitionerDataList" class="odd gradeX">
                                                                          ...
                                                                          <a  ng-click="deletePetitioner(row.pt_id)"> <i  style="cursor:pointer; font-size: 16px;" class="fa fa-trash-o"></i> </a>
