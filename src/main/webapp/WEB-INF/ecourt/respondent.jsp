            ...
            <div class="col-sm-10" style="float:centre">
                <div class="panel panel-default" style="margin-left: 140px;">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group pull-in clearfix">
                            <div class="col-sm-6">
                                <label>Name <span class="text-danger"> * </span></label>
                                 <input type="text" class="form-control" id="caseDetail" name="name" maxlength=100 oninput="this.value = this.value.toUpperCase()"
                        ...
                        </label> <textarea class="form-control" rows="4" col="50" maxlength=100 ng-model="respondentDetails.rt_address" name="address" placeholder="Address Line 1">
                        </textarea>
                        <span style="color: red">
                             <span class="error" ng-show="respondentDetails.rt_address.length < 11"><br> Please enter atleast 10 character</span>
                             <span class="error" ng-show="respondentDetails.rt_address.length > 100"><br> Please enter not more than 100 character</span>
                        </span>
                            </div>
                        </div>
                        <div class="form-group pull-in clearfix">
                            <div class="col-sm-6">
                                <label>Email Id</label> <input type="email" class="form-control" max-length=50 id="caseDetail" name="email" ng-model="respondentDetails.rt_email">
                        ...
                        <span ng-show="respondent.email.$error.email">Invalid email address.</span>
                            ...
                            <div class="col-sm-6">
                                <label>District</label> <!-- <input type="text" class="form-control" maxlength=30 id="caseDetail" name="caseDetail" ng-model="respondentDetails.rt_city">
                            --> <select class="form-control" id="dt_id" name="dt_id" ng-model="respondentDetails.rt_city" 
                        ...
                        <div class="form-group pull-in clearfix">
                            <div class="col-sm-6">
                                <label>Mobile No</label> <input numbers-only class="form-control" id="mobile" name="mobile" maxlength=10 ng-model="respondentDetails.rt_mobile">
                                <!-- <span style="color: red">	
                           ...
                           <span class="error"ng-show="respondent.mobile.$error.pattern"><br>Enter the valid Mobile Number</span>
                            ...
                            <div class="col-sm-6">
                                <label>State </label>
                                <select class="form-control" id="s_id" name="s_id" ng-model="respondentDetails.rt_s_id" ng-options="state.s_id as state.s_name for state in stateList">
                        ...
                        <div class="row pull-right">
                            <div class="col-sm-12">
                                <button class="btn btn-success" ng-disabled="!respondentDetails.rt_address || !respondentDetails.rt_name" ng-click="respondent.$valid && addRespondent(respondentDetails)">Add Respondent</button>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <tbody>
                                    <tr ng-repeat="row in respondentDataList" class="odd gradeX">
                                        ...
                                        <td class="text-center">
                                            ...
                                            <span ng-show=row.rt_sequence!=1>
