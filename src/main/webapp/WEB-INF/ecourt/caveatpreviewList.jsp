...
<div id="content" class="content" ng-controller="cavieatViewController">
   <div class="row">
<div class="col-md-12">
...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/scripts/controllers/caveatPreviewController.js"></script>
<script type="text/javascript"
