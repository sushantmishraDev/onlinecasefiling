                                ...
                                <table id="data-table" class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Select All Remarks <input id="{{row.c_id}}" type="checkbox" value="{{row.c_id}}" name="c_id" ng-click="checkAll()" ng-model="selectedAll" /></th>
                                            <th>Remark</th>
                                        </tr>
                                    </thead>
                                    <tbody>
...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/scripts/controllers/CaveatScrutinyController.js"></script>
<script type="text/javascript"
