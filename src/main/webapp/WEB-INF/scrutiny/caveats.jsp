                    ...
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table id="data-table" class="table table-striped table-bordered" ng-init="getCaveatList()">
                                    <thead>
                                        <tr>
                                            <th>Diary No</th>
                                    ...
                                    <tbody>
                                        <tr  ng-repeat="row in draftList"  class="odd gradeX">
                                            ...
                                            <td>{{row.petitionerDetails.cpt_name}}</td>
                                            <td>{{row.respondentDetails.crt_name}}</td>                                          
                                            <td>{{row.caseType.ct_name}}</td>
                                            <td>                               
                                             	<button class="btn btn-success" ng-click="previewCaveatDetails(row.cav_id)">Preview</button>
                                        	</td>
                                          </tr>
                                    </tbody>
                                </table>
