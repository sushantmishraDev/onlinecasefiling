							...
							<div id="pdfPrep"
								...
								<div align="left">
									...
									<div id=page3 style="padding-left: 10%">
										<ol style="padding-left: 20px;page-break-after: auto;">
											<li ng-repeat="party in firstPrint">{{party}}</li>
										</ol>

										<p contenteditable="true"
											style="word-spacing: 6pt; letter-spacing: 1pt; font-family: 'Arial', 'Times New Roman', serif; font-size: 14pt; line-height: 1.5; text-align: justify; color: blue;"
...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/scripts/application_controllers/searchCaseFile.js?v=3"></script>
