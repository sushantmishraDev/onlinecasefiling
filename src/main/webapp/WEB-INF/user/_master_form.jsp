...
<div class="row">
	...
	<div class="form-group">
		    ...
		    <div class="col-md-7">
	      		<select id="um_bench_code" ng-options="bcd.lk_id as bcd.lk_longname for bcd in branchDataList"
											...
											ng-model="masterentity.um_bench_code" />
									</select> 
	      	</div>		   
	</div>
	</div>
	...
	<div class="form-group">
		    ...
		    <div class="col-md-7">
	      		<input class="form-control" type="text" id="um_fullname" name="um_fullname" ng-model="masterentity.um_fullname" placeholder="User Full Name" ng-minlength=1 ng-maxlength=20	ng-pattern="/^[a-zA-Z0-9]*$/" /> 
	      	</div>		   
	</div>
	</div>
		...
		<div class="form-group">
			    ...
			    <div class="col-md-7">
		      		<select ng-model="masterentity.um_department_id" class="form-control"
							...
							ng-options="td.lk_id as td.lk_longname for td in departmentData"
							required ></select>
				</div>		   
		</div>
	</div>
