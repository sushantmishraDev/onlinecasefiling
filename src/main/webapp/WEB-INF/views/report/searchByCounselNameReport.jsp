...
<div id="content" class="content"
	ng-controller="searchByCounselNameReportCtrl">
	<!-- begin row -->
	<div class="row">
		<div class="col-md-11">
			<!-- begin panel -->
			<div class="panel panel-inverse">
				<div class="panel-heading">
					<h4 class="panel-title">Search By CounselName Report</h4>
				</div>
						...
						<table id="data-table" st-table="displayedCollection"
							...
							<td><select class="form-control"
										ng-model="model.counsel">
											<option value="8">Petitioner</option>
							...
							<td><button type="submit" class="btn btn-sm btn-success"
											ng-click="getSearchByCounselNameReportData()">
...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/scripts/controllers/searchByCounselNameReport.js"></script>
<script type="text/javascript"
