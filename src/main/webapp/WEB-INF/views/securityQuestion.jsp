							...
							<div class="col-md-5 ui-sortable">
							   ...
							   <span ng-show="adduserForm.password.$error.required && adduserForm.password.$dirty">required</span>
							    <br />
							       ...
							       <div class="col-md-6 col-sm-6">
							       <input  class="form-control" type="password" id="passwordc" name="passwordc" placeholder="Confirm Password" ng-model="passwordc" required  />
							   <span ng-show="adduserForm.passwordc.$error.required && adduserForm.passwordc.$dirty">Please confirm your password.</span>
							      <br />
										...
										<div class="form-group" ng-repeat="data in answerDetails">
									...
									<!-- 		<input type="submit" id="submitbtn"
													...
													ng-click="compareAnswer(answerDetails)"
