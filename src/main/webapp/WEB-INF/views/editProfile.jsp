...
<div id="content" class="content" ng-controller="editProfileCtrl">
				...
				<div class="panel-heading">
					<div class="panel-heading-btn">
						<button type="button" class="btn btn-primary btn-sm pull-right"
							ng-click="openModel()">
							<span class="glyphicon glyphicon-plus-sign"></span> Change
							Password
						</button>
					</div>
				...
				<div id="content" class="content" style="width: 80%;">
					<div class="panel-body panel-form" style="width: 80%">
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6">
								<input type="text" class="form-control" id="username"
									name="username" ng-model="userobj.um_fullname" maxlength="20" />
								<br />
							</div>

							<label class="control-label col-md-5 col-sm-5"><h5>Email
									:</h5></label>
							<div class="col-md-6 col-sm-6">
								<input type="text" class="form-control" id="email" name="email"
									ng-model="userobj.um_email" maxlength="5" /> <br />
							</div>

							<label class="control-label col-md-5 col-sm-5"><h5>Mobile
									:</h5></label>
							<div class="col-md-6 col-sm-6">
								<input type="text" class="form-control" id="mobile"
									name="mobile" ng-model="userobj.um_mobile" /> <br />
							</div>
	...
	<input type="submit" id="submitbtn"
										data-loading-text="Loading..." value="Save"
										ng-click="save(userobj)" class="btn btn-success" />
	  -->
			...
			<div class="modal-content">
				<div class="modal-header" style="background-color: black;">
					<button type="button" class="close" data-dismiss="modal"
						aria-label="Close" ng-click="resetform()">
