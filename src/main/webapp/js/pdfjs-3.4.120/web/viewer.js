...
const PDFViewerApplication = {
    ...
    try {
     ...
     // await this.downloadManager.download(blob, url, filename);
      let formData=new FormData();
       console.log(blob.type+" this is try / annotated file download"+ filename);
      let text;
  		if (confirm("Do you want to save!") == true) {
    		text = "You pressed OK!";
    		console.log(text+"  save button work");
    		 formData.append("blob",blob,filename);
      await fetch('/dms/casefile/highlightFile', {
   			 	method: "POST", 
    			body: formData
  				}); 
      alert("Succesfully Saved");
    		...
    		text = "You canceled!";
    		 console.log(text+" Cancele button work");
  			}
  ...
  alert('The file has been uploaded successfully.');*/
      ...
      console.log("this is try / annotated file download");
...
const defaultOptions = {
  ...
  workerSrc: {
    value: "/onlinecasefiling/js/pdfjs-3.4.120/build/pdf.worker.js",
    kind: OptionKind.WORKER
  }
};
{
  ...
  defaultOptions.sandboxBundleSrc = {
    value: "../../js/pdfjs-3.4.120/build/pdf.sandbox.js",
    kind: OptionKind.VIEWER
  };
}
