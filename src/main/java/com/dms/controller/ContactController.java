...
import com.dms.model.Contact;
import com.dms.model.ContactForm;
...
public class ContactController {
	...
	public ModelAndView get() {
		...
		return new ModelAndView("contact/add_contact" , "contactForm", contactForm);
	}
	...
	public ModelAndView save(@ModelAttribute("contactForm") ContactForm contactForm) {
		...
		return new ModelAndView("contact/show_contact", "contactForm", contactForm);
	}
}
