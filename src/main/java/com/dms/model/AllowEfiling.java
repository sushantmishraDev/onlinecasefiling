...
public class AllowEfiling {
	...
	public String toString() {
		return "AllowEfiling [ae_id=" + ae_id + ", ae_reference_mid=" + ae_reference_mid + ", ae_fd_mid=" + ae_fd_mid
				+ ", ae_code=" + ae_code + ", ae_status=" + ae_status + ", ae_allow_for=" + ae_allow_for
				+ ", ae_ex_affidavit_status=" + ae_ex_affidavit_status + ", ae_case_type=" + ae_case_type
				+ ", ae_case_year=" + ae_case_year + ", ae_case_types=" + ae_case_types + ", ae_case_no=" + ae_case_no
				+ ", ae_aor=" + ae_aor + ", ae_appno=" + ae_appno + ", ae_pet_name=" + ae_pet_name + "]";
	}	
